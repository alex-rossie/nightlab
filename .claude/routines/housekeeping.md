...
5. Close any `needs-gpu` PR that has had no runner activity for 7 days with a comment explaining why, unless it has a `keep` label, and re-label the linked issue `queued`.
