...
**It makes throughput a first-class result.** Every ledger row has tokens per second next to validation loss. A change that costs speed has to buy it back in loss within the same ten minutes. Compile time counts.
